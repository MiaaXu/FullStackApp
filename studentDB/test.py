...
class User(flask_login.UserMixin): 
    def __init__(self, studentid, password, enrollment):
        self.id = studentid
...
def user_finder(id):
    ...
    cursor.execute('SELECT StudentID, Password, Enrollment from Students where StudentID = %s', (id,) )
...
def index():
    ...
    return f"Enrollment date: {user.enroll}"
